class MasterInput {
    ...
    setBlur() {
        if (this.input.value == "") {
            ...
            this.label.classList.remove("helper-text");
    ...
    showMessage(message) {
        this.label.classList.add("warning-message");
        this.label.innerHTML = `
        <svg style="position: relative; width: 1em; top: 1px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
